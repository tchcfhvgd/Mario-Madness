...
class Main extends Sprite {
	...
	public static var gameWidth:Int = initialState == 1280; // Width of the game in pixels (might be less / more in actual pixels depending on your zoom).
	public static var gameHeight:Int = initialState == 720; // Height of the game in pixels (might be less / more in actual pixels depending on your zoom).
